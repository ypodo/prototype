...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { mail: @phone.mail, name: @phone.name, phone: @phone.phone, returned: @phone.returned, user: @phone.user }
    end
  ...
  test "should update phone" do
    put :update, id: @phone, phone: { mail: @phone.mail, name: @phone.name, phone: @phone.phone, returned: @phone.returned, user: @phone.user }
    assert_redirected_to phone_path(assigns(:phone))
  end
